...
var keyFound = false;
console.log("You wake up. Your head is pounding. You wipe the sweat off your brow, and notice blood. You wonder where the hell you are, and what the hell happened. You rock from side to side, hoping to alleviate the pain, but the rusty creaks of the bed make the headache worse. You fall off the bed and shield your eyes from the single blinding light overhead, and look at your options. There's a door ten feet in front of you, a hole in the wall, two feet to the left of your face, and some dusty books, and moldy clothes under the bed. What do you do?")
        ...
        var choices = ['Look under the bed', 'Explore the hole in the wall'], index = readline.keyInSelect(choices, 'What do you do?');
            if (index === 0) {
                ...
                var choices = ['Open the door!', 'Stay here'], index = readline.keyInSelect(choices, 'What do you do?');
                    if (index === 0 && keyFound) {
                        console.log("You turn the key, and kick the door open. Natural sunlight floods the room, and you walk out. Hmm... you wonder what the special is at McDonalds. You'll probably get what the special is today, but you already got your side of freedom.")
                    } else {
